...
# Using ARG in FROM requires minimum Docker version v17.05.0-ce
...
# Set the XDG_RUNTIME_DIR to avoid the warning
ENV XDG_RUNTIME_DIR=/tmp/runtime-root

# Create the runtime directory and set the appropriate permissions
